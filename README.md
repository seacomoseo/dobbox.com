...
- [Github new acount](https://github.com/join)
  - User name: `dobboxfrio`
  - Email: `dobboxfrio@seacomoseo.com`
  - Password: `var_pass`
  - Verify and exit
- [New repository](https://github.com/new)
  - `Repository name` = `dobbox.com`
  - `Private` = check
  - `Create repository`
- [Settings](https://github.com/dobboxfrio/dobbox.com/settings) ⏩ check `Include Git LFS objects in archives`
...
- New or fork project
  ...
  - If [Fork this project](https://gitlab.com/dobboxfrio/dobbox.com/-/forks/new)
  - `Project name` and `Project slug` = `dobbox.com`
  - `Visibility level` = `Private`
  - `Initialize repository with a README` = uncheck
- [Mirror repository](https://gitlab.com/dobboxfrio/dobbox.com/-/settings/repository#js-push-remote-settings)
  - `Add new`
  - `Git repository URL` = `https://dobboxfrio@github.com/dobboxfrio/dobbox.com.git`
  - `Password` = prev token from Github (`ghp_**********`)
  - `Mirror repository`
- [Members](https://gitlab.com/dobboxfrio/dobbox.com/-/project_members) ⏩ Add your email with role `Maintainer`
- Icons
  - [General Settings](https://gitlab.com/dobboxfrio/dobbox.com/edit) ⏩ `Project avatar`
...
- [Repository](https://gitlab.com/dobboxfrio/dobbox.com) ⏩ `Clone ⏩ Visual Studio Code (HTTPS)` ⏩ select sansoul folder (not new folder)
...
- `Skip personalization ⏩ New site from Git ⏩ Gitlab ⏩ Authorize ⏩ Select repo ⏩ Deploy site ⏩ Site settings`
  - `Change site name ⏩ dobboxfrio` and copy in `data/config.yml ⏩ netlify_name`
  - Copy `API ID` in `data/config.yml ⏩ netlify_id`
  - [Build hooks](https://app.netlify.com/sites/dobboxfrio/settings/deploys#build-hooks) with = `build` name ⏩ copy and paste in `dobbox.com/dobbox.com.md` and [spreadsheet projects](https://docs.google.com/spreadsheets/d/1QIeT5VfUuXC3momIScZPf8ZPahV23tXVNshcf6DRipA/).
...
- [Cloudflare Pages new project with Gitlab](https://dash.cloudflare.com/?to=/:account/pages/new/provider/gitlab)
  ...
  - `Project name` = `dobboxfrio` and copy in `data/config.yml ⏩ cloudflare_project_name`
...
- If Identity Access
  - [`Netlify ⏩ Site ⏩ Settings ⏩ Identity`](https://app.netlify.com/sites/dobboxfrio/settings/identity) ⏩ `Enable Identity`
    - [`Git Gateway`](https://app.netlify.com/sites/dobboxfrio/settings/identity#git-gateway) ⏩ `Edit settings` ⏩ Paste the gitlab code copied in `GitLab personal access token ⏩ Save`
    - [Registration preferences](https://app.netlify.com/sites/dobboxfrio/settings/identity#registration-preferences) ⏩ Edit settings ⏩ Invite only ⏩ Save
    - [`External providers`](https://app.netlify.com/sites/dobboxfrio/settings/identity#external-providers) ⏩ Add provider ⏩ Gitlab ⏩ Use default configuration ⏩ Enable GitLab
  - [`Netlify ⏩ Site ⏩ Identity`](https://app.netlify.com/sites/dobboxfrio/identity) ⏩ Invite users ⏩ email `dobboxfrio@seacomoseo.com` (and other if you want) ⏩ Check email from `no-reply@netlify.com` ⏩ Accept the invite ⏩ Add `/admin/` in the URL between `/` and `#` ⏩ Add password `var_pass`
...
- If new project (not fork):
  - Copy [dobbox.com project files](https://github.com/dobboxfrio/dobbox.com)
...
- `README.md` ⏩ edit baseURL ("dobbox.com") + delete steps bit by bit
- Design
...
- If Cloudflare Pages
  - [Custom domains](https://dash.cloudflare.com/?to=/:account/pages/view/dobboxfrio/domains)
  - `Set up a custom domains`
  - `dobbox.com`
  - `Continue`
  - `Activate domain` (if `Begin DNS transfer` end)
  - Repeat with `www.dobbox.com`
  - ...........................................................
...
- If Netlify Form
  ...
  - [`Netlify ⏩ Site ⏩ Forms ⏩ Form Notifications`](https://app.netlify.com/sites/dobboxfrio/settings/forms#form-notifications) ⏩ `Add notification ⏩ Email notification ⏩ Email to Notify`
    - `Email to notify` = Emails of collaborators that want receive submissions
    - `Custom email subject line` = `Formulario de contacto de dobbox.com`
    - `Save`
  - Submissions: [`Netlify site ⏩ Forms`](https://app.netlify.com/sites/dobboxfrio/forms)
...
1. [Servicios dobbox.com](https://drive.google.com/file/d/1trq28fMfEVwoZOk4ue0tJzAJDZtj64BK) ⏩ `File ⏩ Make a copy` ⏩ Select client directory.
1. Change the info.
